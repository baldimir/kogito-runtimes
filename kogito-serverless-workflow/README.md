...
1. [Event Example](https://github.com/kubesmarts/kogito-examples/tree/main/serverless-workflow-examples/serverless-workflow-events-quarkus)
2. [Operation Example](https://github.com/kubesmarts/kogito-examples/tree/main/serverless-workflow-examples/serverless-workflow-functions-quarkus)
3. [Switch, Parallel, and SubFlow Example](https://github.com/kubesmarts/kogito-examples/tree/main/serverless-workflow-examples/serverless-workflow-order-processing)
4. [Inject and Switch Example](https://github.com/kubesmarts/kogito-examples/tree/main/serverless-workflow-examples/serverless-workflow-greeting-quarkus)
5. [Callback Example](https://github.com/kubesmarts/kogito-examples/tree/main/serverless-workflow-examples/serverless-workflow-callback-quarkus)
...
1. [Functions With Quarkus](https://github.com/kubesmarts/kogito-examples/tree/main/serverless-workflow-examples/serverless-workflow-functions-quarkus)
2. [Funqy](https://github.com/kubesmarts/kogito-examples/tree/main/serverless-workflow-examples/serverless-workflow-functions-quarkus)
3. [The GitHub Showcase](https://github.com/kubesmarts/kogito-examples/tree/main/serverless-workflow-examples/serverless-workflow-github-showcase)
4. [Greetings Example With Quarkus](https://github.com/kubesmarts/kogito-examples/tree/main/serverless-workflow-examples/serverless-workflow-greeting-quarkus)
5. [Temperature Conversion Example](https://github.com/kubesmarts/kogito-examples/tree/main/serverless-workflow-examples/serverless-workflow-temperature-conversion)
...
1. [Events With Quarkus](https://github.com/kubesmarts/kogito-examples/tree/main/serverless-workflow-examples/serverless-workflow-events-quarkus)
2. [Functions With Events](https://github.com/kubesmarts/kogito-examples/tree/main/serverless-workflow-examples/serverless-workflow-functions-events-quarkus)
3. [Order Processing](https://github.com/kubesmarts/kogito-examples/tree/main/serverless-workflow-examples/serverless-workflow-order-processing)
...
1. [Expressions With Quarkus](https://github.com/kubesmarts/kogito-examples/tree/main/serverless-workflow-examples/serverless-workflow-expression-quarkus)
...
1. [Error Handling With Quarkus](https://github.com/kubesmarts/kogito-examples/tree/main/serverless-workflow-examples/serverless-workflow-error-quarkus)
...
1. [Workflow Compensation With Quarkus](https://github.com/kubesmarts/kogito-examples/tree/main/serverless-workflow-examples/serverless-workflow-compensation-quarkus)
