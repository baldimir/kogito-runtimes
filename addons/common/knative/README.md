...
- [serverless-workflow-order-processing](https://github.com/kubesmarts/kogito-examples/tree/stable/kogito-quarkus-examples/serverless-workflow-order-processing)
