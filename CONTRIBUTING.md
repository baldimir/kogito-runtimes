...
We decided to disallow `@author` tags in the Javadoc: they are hard to maintain, especially in a very active project, and we use the Git history to track authorship. GitHub also has [this nice page with your contributions](https://github.com/kubesmarts/kogito-runtimes/graphs/contributors).
...
Make sure you have configured your IDE according to the [project codestyle](https://github.com/kubesmarts/kogito-runtimes/tree/main/kogito-build/kogito-ide-config).
...
- **Edit dependencies** in **[kogito-build-parent](https://github.com/kubesmarts/kogito-runtimes/blob/main/kogito-build/kogito-build-parent/pom.xml)**.
...
Don't forget to include tests in your pull requests, and documentation (reference documentation, javadoc...). Guides and reference documentation should be submitted to the [Kogito Docs Repository](https://github.com/kubesmarts/kie-docs/tree/main-kogito).
If you are contributing a new feature, we strongly advise submitting an [Example](https://github.com/kubesmarts/kogito-examples). 
...
```bash
git clone https://github.com/kubesmarts/kogito-runtimes.git
cd kogito-runtimes
